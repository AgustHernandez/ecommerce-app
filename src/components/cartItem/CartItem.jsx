    ...
    return (
        <div key={producto.id} className='card'>
            ...
            <div className='containerDescrip'>
                <p className='infoProd'>{producto.nombre}</p>
                <p className='infoProd'>Cantidad: {producto.cantidad} </p>
            </div>
            <div className='containerDescrip'>
                <p className='infoProd'>$ {producto.precio} </p>
            </div>
            <button className='buttonProd' onClick={ () => removerProd(producto.id) }> 
