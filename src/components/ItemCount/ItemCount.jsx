  ...
  return (
    <div className='container'>
      <div className='containerCant'>
        <button onClick={restaCant} className='buttonCant'>
        ...
        <button onClick={sumaCant} className='buttonCant'>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={15} height={15}>
      ...
      <div>
        <button onClick={mostrarCant} className='buttonAgregar'>Agregar al carrito</button>
      </div>
    </div>
  )
}
